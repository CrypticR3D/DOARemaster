...
public class Switch : MonoBehaviour
{
    ...
    // List to store references to the switches
    private List<InteractAnimation> switches = new List<InteractAnimation>();

    // Add references to the switches in the inspector
    public InteractAnimation[] switchControllers;
